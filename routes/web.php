...
Route::middleware(['auth'])->group(function () {
    ...
    // AI Assistant (cross-portal: clients, owners, studio photographers) ===================================================================================================
    Route::prefix('chatbot')->name('chatbot.')->middleware('throttle:30,1')->group(function () {

        Route::get('/config', [\App\Http\Controllers\ChatbotController::class, 'getConfig'])->name('config');
        Route::post('/start', [\App\Http\Controllers\ChatbotController::class, 'startChat'])->name('start');
        Route::post('/message', [\App\Http\Controllers\ChatbotController::class, 'sendMessage'])->name('message');
        Route::post('/end', [\App\Http\Controllers\ChatbotController::class, 'endChat'])->name('end');
        Route::get('/history', [\App\Http\Controllers\ChatbotController::class, 'getHistory'])->name('history');
        Route::post('/helpful', [\App\Http\Controllers\ChatbotController::class, 'markHelpful'])->name('helpful');
        Route::post('/not-helpful', [\App\Http\Controllers\ChatbotController::class, 'markNotHelpful'])->name('not-helpful');
