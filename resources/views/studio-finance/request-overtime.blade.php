            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                        ...
                        <a href="{{ route('studio-finance.overtime-requests.index') }}" class="btn btn-light">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#requestOvertimeForm').on('submit', function (event) {
                ...
                $.ajax({
                    url: '{{ route('studio-finance.overtime-requests.store') }}',
                    method: 'POST',
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            Swal.fire({
                                ...
                                didClose: function () {
                                    window.location.href = '{{ route('studio-finance.overtime-requests.index') }}';
                                }
                            });
