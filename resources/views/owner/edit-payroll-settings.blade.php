                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="notes" rows="3"
                                                  placeholder="Additional notes about payroll settings..."
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#payrollForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '/owner/payroll-settings/' + $('#payrollId').val(),
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                didClose: () => {
                                    window.location.href = '{{ route("owner.payroll-settings.index") }}';
                                }
                            });
                        } else {
                            Swal.fire({
