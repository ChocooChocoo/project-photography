                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="btn-group w-100" role="group" aria-label="Payroll Basis Toggle">
                                            <input type="radio" class="btn-check" name="payroll_basis"
                                                   id="basisAttendance" value="attendance_only"
                                                   {{ isset($canCreate) && !$canCreate ? 'disabled' : '' }} required>
                                            <label class="btn btn-outline-primary" for="basisAttendance">
                                                Attendance Only
                                            </label>
                                            <input type="radio" class="btn-check" name="payroll_basis"
                                                   id="basisBooking" value="booking_and_attendance"
                                                   {{ isset($canCreate) && !$canCreate ? 'disabled' : '' }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#studioSelect').on('change', function() {
                ...
                $.ajax({
                    url: '/owner/payroll-settings/employees',
                    method: 'GET',
                    data: {
                        studio_id: studioId,
