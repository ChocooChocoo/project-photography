                                        ...
                                        <tr data-payroll-id="{{ $payroll->id }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <a href="{{ route('owner.payroll-settings.edit', $payroll->id) }}" class="btn btn-sm" title="Edit">
                                    ...
                                    @empty
                                        <tr id="dbEmptyRow">
                                            <td colspan="10" class="text-center py-4">
                                                ...
                                                <a href="{{ route('owner.payroll-settings.create') }}" class="btn btn-primary btn-sm mt-2">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-payroll', function() {
                ...
                $.ajax({
                    url: '/owner/payroll-settings/' + payrollId,
                    method: 'GET',
            ...
            $(document).on('click', '.toggle-status', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/owner/payroll-settings/' + payrollId + '/status',
                            method: 'PUT',
                            headers: {
