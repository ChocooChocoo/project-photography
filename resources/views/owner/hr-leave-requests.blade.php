            ...
            <div class="row mt-3">
                @php
                    ...
                    $leaveSummaryCards = [
                        ...
                        ['count' => $leaveRequestSummary['approved'], 'label' => 'Approved Requests', 'meta' => 'DECISIONS MADE', 'color' => 'success', 'icon' => 'ti ti-checklist'],
                        ['count' => $leaveRequestSummary['rejected'], 'label' => 'Rejected Requests', 'meta' => 'DECLINED', 'color' => 'danger', 'icon' => 'ti ti-xbox-x'],
