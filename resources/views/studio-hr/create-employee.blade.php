                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select" name="role_id" id="roleSelect" required {{ $fieldState }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadCategories() {
                ...
                $.ajax({
                    url: "{{ route('studio-hr.employee.categories') }}",
                    method: 'GET',
                    success: function(response) {
            ...
            $('#employeeForm').on('submit', function(e) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "{{ route('studio-hr.employee.store') }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                didClose: () => {
                                    window.location.href = "{{ route('studio-hr.employee.index') }}";
                                }
                            });
                        } else {
                            Swal.fire({
