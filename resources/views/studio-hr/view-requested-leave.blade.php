        ...
        <div class="container-fluid">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Review and manage your submitted leave requests while waiting for Studio Owner approval.</p>
                        </div>
                        <a href="{{ route('studio-hr.leave-requests.create') }}" class="btn btn-primary">
                ...
                @php
                    ...
                    $leaveSummaryCards = [
                        ['count' => $leaveRequestSummary['pending'], 'label' => 'Pending Requests', 'meta' => 'WAITING OWNER', 'color' => 'warning', 'icon' => 'ti ti-clock-hour-4'],
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            const leaveRequestBaseUrl = '{{ url('/studio-hr/leave-requests') }}';
