                ...
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Submit your leave request for Studio Owner review and final approval.</p>
                        </div>
                        <a href="{{ route('studio-hr.leave-requests.index') }}" class="btn btn-light">
                        ...
                        <div class="card-body">
                            ...
                            <div class="border rounded p-3 bg-light-subtle mb-3">
                                ...
                                <p class="text-muted mb-0 mt-2 small">
                                    Your leave request will remain pending until the Studio Owner reviews it.
                                </p>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning d-flex align-items-start gap-2 mb-4" role="alert">
                                ...
                                <div>
                                    <strong>Reminder:</strong> Provide complete leave details before submitting so the request can be reviewed properly.
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#requestLeaveForm').on('submit', function (event) {
                ...
                $.ajax({
                    url: '{{ route('studio-hr.leave-requests.store') }}',
                    method: 'POST',
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            Swal.fire({
                                ...
                                didClose: function () {
                                    window.location.href = '{{ route('studio-hr.leave-requests.index') }}';
                                }
                            });
