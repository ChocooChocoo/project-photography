                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate id="payrollForm">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{ $payroll->employee->profile_photo_url }}"
                                                                     class="rounded-circle"
                                                                     width="60" height="60"
                                                                     onerror="this.src='{{ asset('assets/images/users/user-3.jpg') }}'"
                                        ...
                                        <div id="customAllowancesContainer">
                                            @if($payroll->custom_allowances && count($payroll->custom_allowances) > 0)
                                                ...
                                                <div class="row mb-2 custom-allowance-item">
                                                    ...
                                                    <div class="col-md-2">
                                                        @if(!isset($canUpdate) || $canUpdate)
                                                            <button type="button" class="btn btn-sm btn-soft-primary remove-custom-item">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            @if(!isset($canUpdate) || $canUpdate)
                                                <button type="button" class="btn btn-sm btn-soft-primary" id="addCustomDeduction">
                                ...
                                <div class="row mb-3">
                                    ...
                                    {{-- Tax Fields Row --}}
                                    <div class="col-md-4 mb-3 tax-fields" style="{{ !$payroll->is_taxable ? 'display: none;' : '' }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="tax_code"
                                               value="{{ $payroll->tax_code }}" placeholder="e.g., WITH-2024"
                                               {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>
                                    </div>
                                    ...
                                    {{-- VAT Fields Row --}}
                                    <div class="col-md-4 mb-3 vat-fields" style="{{ !$payroll->subject_to_vat ? 'display: none;' : '' }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" name="absent_deduction_method" id="absentDeductionMethod"
                                            {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>
                                            <option value="deduct_daily_rate" {{ $payroll->absent_deduction_method == 'deduct_daily_rate' ? 'selected' : '' }}>Deduct Daily Rate</option>
                                            <option value="deduct_fixed_amount" {{ $payroll->absent_deduction_method == 'deduct_fixed_amount' ? 'selected' : '' }}>Deduct Fixed Amount</option>
                                            <option value="deduct_percentage" {{ $payroll->absent_deduction_method == 'deduct_percentage' ? 'selected' : '' }}>Deduct Percentage</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3 payday-fields" id="payday1Field"
                                         style="{{ !in_array($payroll->payment_schedule, ['semi_monthly', 'monthly']) ? 'display: none;' : '' }}">
                                    ...
                                    <div class="col-md-4 mb-3 payday-fields" id="payday2Field"
                                         style="{{ $payroll->payment_schedule != 'semi_monthly' ? 'display: none;' : '' }}">
                                    ...
                                    <div class="col-md-4 mb-3 payday-fields" id="paydayWeeklyField"
                                         style="{{ $payroll->payment_schedule != 'weekly' ? 'display: none;' : '' }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="bank_name"
                                               value="{{ $payroll->bank_name }}" placeholder="e.g., BDO, BPI, MetroBank"
                                               {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="bank_account_number"
                                               value="{{ $payroll->bank_account_number }}" placeholder="Account number"
                                               {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="bank_account_name"
                                               value="{{ $payroll->bank_account_name }}" placeholder="Account holder name"
                                               {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="notes" rows="3" placeholder="Additional notes about payroll settings..."
                                                  {{ isset($canUpdate) && !$canUpdate ? 'disabled' : '' }}>{{ $payroll->notes }}</textarea>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function restrictPayrollBasisByRole(role) {
                ...
                // Note: In edit mode, the payroll_basis is already set via hidden field
                // We're just disabling the radio buttons for visual feedback
