        ...
        <div class="container-fluid">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Submit your overtime request for Studio Owner review and approval.</p>
                        </div>
                        <a href="{{ route('studio-hr.overtime-requests.index') }}" class="btn btn-light">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="border rounded p-3 bg-light-subtle mb-3">
                                ...
                                <h5 class="mb-0">{{ $hrUser->full_name }}</h5>
                                <small class="text-muted">{{ $hrUser->email }}</small>
                            </div>
                            ...
                            <div class="border rounded p-3 bg-light-subtle mb-3">
                                ...
                                <p class="text-muted mb-0 mt-2 small">
                                    Your overtime request will remain pending until the Studio Owner reviews it.
                                </p>
                            </div>
                ...
                <div class="col-12 col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Overtime Request Form</h5>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-warning d-flex align-items-start gap-2 mb-4" role="alert">
                                <i class="ti ti-alert-triangle fs-18 mt-1"></i>
                                <div>
                                    <strong>Reminder:</strong> Provide complete overtime details before submitting so the Studio Owner can review your request properly.
                                </div>
                            </div>
                            ...
                            <form id="requestOvertimeForm">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <label for="overtime_date" class="form-label">Overtime Date <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" id="overtime_date" name="overtime_date" min="{{ now()->toDateString() }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="reason" name="reason" rows="6" placeholder="State the reason for your overtime request..."></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#requestOvertimeForm').on('submit', function (event) {
                ...
                $.ajax({
                    url: '{{ route('studio-hr.overtime-requests.store') }}',
                    method: 'POST',
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            Swal.fire({
                                ...
                                didClose: function () {
                                    window.location.href = '{{ route('studio-hr.overtime-requests.index') }}';
                                }
                            });
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: response.message || 'Failed to submit the overtime request.',
                    ...
                    error: function (xhr) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: xhr.responseJSON?.message || 'Failed to submit the overtime request.',
                            confirmButtonColor: '#3475db'
                        });
                    },
                    complete: function () {
