                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-12 col-md-6"><div class="d-flex align-items-start"><div class="flex-shrink-0"><div class="bg-light-primary rounded-circle p-2"><i class="ti ti-stamp fs-20 text-primary"></i></div></div><div class="flex-grow-1 ms-3"><label class="text-muted small mb-1">Status</label><p class="mb-0 fw-medium" id="modalPayrollStatus">Pending</p></div></div></div>
                                    <div class="col-12 col-md-6"><div class="d-flex align-items-start"><div class="flex-shrink-0"><div class="bg-light-primary rounded-circle p-2"><i class="ti ti-user-star fs-20 text-primary"></i></div></div><div class="flex-grow-1 ms-3"><label class="text-muted small mb-1">Reviewed By</label><p class="mb-0 fw-medium" id="modalReviewedBy">Not reviewed yet.</p></div></div></div>
                                    <div class="col-12 col-md-6"><div class="d-flex align-items-start"><div class="flex-shrink-0"><div class="bg-light-primary rounded-circle p-2"><i class="ti ti-clock-check fs-20 text-primary"></i></div></div><div class="flex-grow-1 ms-3"><label class="text-muted small mb-1">Reviewed At</label><p class="mb-0 fw-medium" id="modalReviewedAt">Not reviewed yet.</p></div></div></div>
                                    <div class="col-12 col-md-6"><div class="d-flex align-items-start"><div class="flex-shrink-0"><div class="bg-light-primary rounded-circle p-2"><i class="ti ti-message-report fs-20 text-primary"></i></div></div><div class="flex-grow-1 ms-3"><label class="text-muted small mb-1">Rejection Reason</label><p class="mb-0 fw-medium" id="modalRejectionReason">No rejection reason provided.</p></div></div></div>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function populateGeneratedPayrollModal(data) {
                ...
                $('#modalPayrollStatus').text(data.status_display);
                $('#modalReviewedBy').text(data.reviewed_by);
                $('#modalReviewedAt').text(data.reviewed_at);
                $('#modalRejectionReason').text(data.rejection_reason);
