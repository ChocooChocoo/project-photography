# Detailed Revision Checklist and Recommendations

> **In plain terms:** This preserves the detailed historical findings and recommendations. It does not approve unimplemented recommendations.
>
...
> [`../03-PROGRESS/ROADMAP PROGRESS.md`](../05-progress/delivery-history.md), which takes precedence.
...
> - [`TECHNICAL ANALYSIS.md`](technical-analysis.md) — technical detail, architecture, flowcharts
> - [`NON TECHNICAL ANALYSIS.md`](../00-overview/plain-summary.md) — plain-language walkthrough + glossary
>
...
> Added 2026-07-26 from `prompt/tasks/07.md`. Item 2 above covers *studio-side* cancellation (now shipped as roadmap 2.5). This is its photographer-side sibling, which 2.5 does not touch. Full analysis: [`../04-REFERENCE/PHOTOGRAPHER CANCELLATION CONTINGENCY.md`](../08-references/photographer-cancellation-contingency.md).
...
> Added 2026-07-27 from `prompt/tasks/08.md`. Full analysis: [`../04-REFERENCE/SUBSCRIPTION LIFECYCLE.md`](../08-references/subscription-lifecycle.md).
...
1. **System Scan** — moved out of this file to avoid duplication; the 7 user roles, portal breakdown, and end-to-end system flow now live in [`TECHNICAL ANALYSIS.md`](technical-analysis.md) and [`NON TECHNICAL ANALYSIS.md`](../00-overview/plain-summary.md) (see Part 1 above)
