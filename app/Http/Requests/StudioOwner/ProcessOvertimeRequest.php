...
/**
 * Validate Studio Owner overtime request approval and rejection actions.
 */
class ProcessOvertimeRequest extends FormRequest
{
    ...
    {
        return [
            'action.required' => 'Please specify the overtime request action.',
            'action.in' => 'The selected overtime request action is invalid.',
            'rejection_reason.required_if' => 'Please provide a reason when rejecting an overtime request.',
